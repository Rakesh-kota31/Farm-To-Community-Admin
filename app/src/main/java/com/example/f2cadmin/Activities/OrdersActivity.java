...
import com.example.f2cadmin.Model.CartModel;
import com.example.f2cadmin.Model.OrderModel;
import com.example.f2cadmin.OrderAdapter;
import com.example.f2cadmin.databinding.ActivityOrdersBinding;
                        ...
                        for (DataSnapshot dataSnapshot1 : dataSnapshot.getChildren()){
                            for (DataSnapshot dataSnapshot2 : dataSnapshot1.getChildren()){
                                for (DataSnapshot dataSnapshot3 : dataSnapshot2.getChildren()){
                                    ...
                                    assert model !=null;
                                    if (dataSnapshot3.child("publisher").getValue().toString().equals(user.getUid())){   //"Placed"
                                        list.add(orderModel);
                                    }
                                }
                            }
